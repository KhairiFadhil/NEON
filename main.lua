...
function NEON:CreateKeyPage(cfg)
	...
	local prefix = new("TextLabel", { Parent = inputBox, LayoutOrder = 1, BackgroundTransparency = 1, Size = UDim2.fromOffset(68, 50), Text = "⌘", TextColor3 = ACCENT, FontFace = bodyFont(Enum.FontWeight.ExtraBold), TextSize = 15 })
	...
	local pasteBtn = new("TextButton", { Parent = inputBox, LayoutOrder = 3, BackgroundTransparency = 1, AutoButtonColor = false, Size = UDim2.fromOffset(68, 50), Text = "PASTE", TextColor3 = ACCENT, TextTransparency = 0.3, FontFace = bodyFont(Enum.FontWeight.Bold), TextSize = 10 })
